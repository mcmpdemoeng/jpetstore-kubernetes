...
def get_order_number_details(tenant_system_user_name,tenant_system_user_api_key,service_instance_id,tenant_api_url):
...
if __name__ == "__main__":
    ...
    order_details = get_order_number_details(tenant_system_user_name,tenant_system_user_api_key,service_instance_id,tenant_api_url)
